...
Product.create!([
  ...
  {name: "Shovel", price: "33.33", description: "Digs and shovels.", in_stock: nil, supplier_id: 3},
  {name: "cucumber seeds", price: "4.0", description: "40 pack of seeds", in_stock: false, supplier_id: 3},
  {name: "Worms", price: "4.0", description: "Slimy, brown, lives in the ground.", in_stock: true, supplier_id: 2}
])
